            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input required disabled name="branch_id" value={formData.branch_id} onChange={handleChange} type="text" className="w-full px-4 py-2 bg-zinc-50 border border-zinc-200 rounded-xl text-sm text-zinc-500 cursor-not-allowed" />
                </div>
              </div>
            </div>
        ...
        <div className="w-full lg:w-80 space-y-6">
          <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-5 shadow-sm">
            ...
            <div className="text-sm text-zinc-600 mb-4">
              You are logged in as <span className="inline-flex px-2 py-0.5 rounded bg-emerald-100 text-emerald-700 font-bold text-xs ml-1">MANAGER</span>
            </div>
            <ul className="space-y-3 text-sm text-zinc-600">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                You can edit your own subordinates
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                Cannot edit Superadmins or Managers
              </li>
            </ul>
          </div>
